			...
			<table class="table table-striped">
				...
				<tbody>
					<?php
						...
						$query = mysqli_query($conn, "SELECT id_pesan, tgl_pesan, nik, nama, alamat, tgl_berangkat, total, konfirm FROM pesanan WHERE fixed = '1' AND konfirm='0' ORDER BY tgl_berangkat ASC")or die(mysqli_error($conn));
